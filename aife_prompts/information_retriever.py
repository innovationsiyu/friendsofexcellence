...
- Once the tool result containing a URL ending in ".csv" or ".docx" has been returned, please present it in your reply and let the user click the URL to download the file."""
