...
[
    {{
        ...
        "freshness_or_year_range": [2023, 2025]
    }},
    {{
        ...
        "freshness_or_year_range": [2025, 2025]
    }},
    {{
    ...
    {{
        "search_target": "Search target 4",
        "acceptance_criteria": "The criteria that an acceptable search result should meet for search target 4",
        "required_quantity": 20,
